              ...
              <tr key={precinto.id} className="hover:bg-gray-750">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center space-x-3">
                    <span className="text-sm font-medium text-white">{precinto.numeroPrecinto}</span>
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div>
                    ...
                    <span className="text-sm text-cyan-400 ml-2">/ {precinto.mov}</span>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className={cn(
